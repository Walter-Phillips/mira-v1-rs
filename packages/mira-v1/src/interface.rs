...
pub const AMM_CONTRACT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/mira_amm_contract/release/mira_amm_contract.bin"
);

pub const ADD_LIQUIDITY_SCRIPT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/add_liquidity_script/release/add_liquidity_script.bin"
);
pub const REMOVE_LIQUIDITY_SCRIPT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/remove_liquidity_script/release/remove_liquidity_script.bin"
);
pub const SWAP_EXACT_INPUT_SCRIPT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/swap_exact_input_script/release/swap_exact_input_script.bin"
);
pub const SWAP_EXACT_OUTPUT_SCRIPT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/swap_exact_output_script/release/swap_exact_output_script.bin"
);
pub const CREATE_POOL_AND_ADD_LIQUIDITY_SCRIPT_BINARY_PATH: &str = concat!(
    env!("CARGO_MANIFEST_DIR"),
    "packages/mira-v1/sway-abis/create_pool_and_add_liquidity_script/release/create_pool_and_add_liquidity_script.bin"
);
